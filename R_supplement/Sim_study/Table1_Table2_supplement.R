...
n=16; m=6
k=4
load("res_16_6_4_100probit.RData"); 
t1probit16_6_4 <- get.results(sim.output, n, m, k)
k=6
load("res_16_6_6_100probit.RData"); 
t1probit16_6_6 <- get.results(sim.output, n, m, k)
k=10
load("res_16_6_10_100probit.RData"); 
t1probit16_6_10 <- get.results(sim.output, n, m, k)
n=90; m=6
k=4
load("res_90_6_4_100probit.RData"); 
t1probit90_6_4 <- get.results(sim.output, n, m, k)
k=6
load("res_90_6_6_100probit.RData"); 
t1probit90_6_6 <- get.results(sim.output, n, m, k)
k=10
load("res_90_6_10_100probit.RData"); 
t1probit90_6_10 <- get.results(sim.output, n, m, k)
#Table 3
round(t1probit16_6_4, 3)
round(t1probit16_6_6, 3)
round(t1probit16_6_10, 3)
round(t1probit90_6_4, 3)
round(t1probit90_6_6, 3)
round(t1probit90_6_10, 3)
...
n=16; m=6
k=4
load("res_16_6_4_100cloglog.RData"); 
t2cloglog16_6_4 <- get.results(sim.output, n, m, k)
k=6
load("res_16_6_6_100cloglog.RData"); 
t2cloglog16_6_6 <- get.results(sim.output, n, m, k)
k=10
load("res_16_6_10_100cloglog.RData"); 
t2cloglog16_6_10 <- get.results(sim.output, n, m, k)
n=90; m=6
k=4
load("res_90_6_4_100cloglog.RData"); 
t2cloglog90_6_4 <- get.results(sim.output, n, m, k)
k=6
load("res_90_6_6_100cloglog.RData"); 
t2cloglog90_6_6 <- get.results(sim.output, n, m, k)
k=10
load("res_90_6_10_100cloglog.RData"); 
t2cloglog90_6_10 <- get.results(sim.output, n, m, k)
#Table 3
round(t2cloglog16_6_4, 3)
round(t2cloglog16_6_6, 3)
round(t2cloglog16_6_10, 3)
round(t2cloglog90_6_4, 3)
round(t2cloglog90_6_6, 3)
round(t2cloglog90_6_10, 3)
