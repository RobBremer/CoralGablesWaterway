...
load(file="nature2008_multy_10.RData")
#class(qPCRdata)
ctsMulty  <- qPCRdata[[1]]
...
load(file="nature2008_noise.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="nature2008_theta_noise.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="nature2008_theta.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="nature2008_fit.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="nature2008_fit_theta.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
mtext("Ras mutation",side=1,line=6,cex=1.5)
