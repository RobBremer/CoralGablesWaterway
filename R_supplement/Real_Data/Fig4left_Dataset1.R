...
load("oncogene2013_Single.RData")
data(oncogene2013); GroupVar=c("sampleType","treatment")
cts       <- qPCRdata
...
conds     <- apply(pData(dCt)[,c("sampleType","treatment")],1,paste,collapse=":")
...
load(file="oncogene2013_multy_10.RData")
#class(qPCRdata)
ctsMulty  <- qPCRdata[[1]]
...
load(file="oncogene2013_noise.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="oncogene2013_theta_noise.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="oncogene2013_theta.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="oncogene2013_fit.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
load(file="oncogene2013_fit_theta.RData")
#class(qPCRdata)
ctsMulty   <- qPCRdata[[1]]
dCtMulty   <- normalizeCtData(ctsMulty, norm = "deltaCt", deltaCt.genes = "Becn1")
dCtMulty   <- dCtMulty[-which(featureNames(dCtMulty)=="Becn1"),]
...
plot(x=jitter(xdHDAC,amount=0.1), y=ydHDAC, pch=8, xaxt="n", yaxt="n", 
     ylab=expression(paste("-",Delta,"Ct",sep="")), xlab="", main="", 
...
mtext("Sample Type Normal / Treatment VA",side=1,line=6,cex=1.5)
