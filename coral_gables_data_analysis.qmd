...
faire_cgw[53, c("project_number", "site", "informal_depth", "verbatimEventDate")]
...
write.csv(faire_cgw,"C:/Users/Robert.Bremer/Downloads/cgw_FAIRe_edited20251222.csv")

write.csv(old_cgw_mst, "C:/Users/Robert.Bremer/Downloads/old_cgw_mst.csv")
```
...
write_xlsx(dg32024, "C:/Users/Robert.Bremer/Downloads/dg32024.xlsx")
...
ggplot(nutrients2021, aes(season, si_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "Silicates 2021") + 
  stat_summary(fun = "mean",
...
ggplot(nutrients2021, aes(site, no2_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "NO2 2021")+
  stat_summary(fun = "mean",
...
ggplot(nutrients2021, aes(season, no2_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "NO2 2021")+
  stat_summary(fun = "mean",
...
ggplot(nutrients2021, aes(season, no3_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "NO3 2021")+
  stat_summary(fun = "mean",
...
ggplot(nutrients2021, aes(site, no3_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "NO3 2021")+
  stat_summary(fun = "mean",
...
ggplot(nutrients2021, aes(season, n_n_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
...
ggplot(nutrients2021, aes(site, n_n_u_m)) +
  geom_violin()+
  geom_jitter(aes(color = season))+
  labs(title = "NO2 + NO3 2021")+
  stat_summary(fun = "mean",
...
write_xlsx(e1a_set, "C:/Users/Robert.Bremer/Downloads/e1a_set.xlsx")
